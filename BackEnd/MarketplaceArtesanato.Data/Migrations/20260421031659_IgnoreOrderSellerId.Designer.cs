...
namespace MarketplaceArtesanato.Data.Migrations
{
    ...
    [Migration("20260421031659_IgnoreOrderSellerId")]
    partial class IgnoreOrderSellerId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketplaceArtesanato.Core.Entities.Banner", b =>
                {
                    ...
                    b.Property<int?>("FontSizeSubtitle")
                        .HasColumnType("int");

                    b.Property<int?>("FontSizeTitle")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceArtesanato.Core.Entities.Coupon", b =>
                {
                    ...
                    b.Property<bool>("OnlyFirstPurchase")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("OnlyWithoutPromotion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<decimal?>("PlatformSharePercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");

                    b.Property<bool>("PreventsCombination")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("MarketplaceArtesanato.Core.Entities.CouponUsage", b =>
                {
                    ...
                    b.Property<decimal?>("PlatformPaid")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("SellerPaid")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MarketplaceArtesanato.Core.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingCostBySellerJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ShippingDeadlineDays")
                        .HasColumnType("int");
